        ...
        <ext:FormPanel 
                ...
                <ext:GridPanel                     
                    ...
                    <ColumnModel runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server" Text="Rating" Width="30" Sortable="true" DataIndex="rating">
            ...
            <Buttons>
                <ext:Button runat="server" Text="Save To Grid">
                    <Listeners>
                        <Click Handler="var form = this.up('form'); form.getForm().updateRecord(form.down('grid').getSelectionModel().getLastSelected());" />
                    </Listeners>
                </ext:Button>
