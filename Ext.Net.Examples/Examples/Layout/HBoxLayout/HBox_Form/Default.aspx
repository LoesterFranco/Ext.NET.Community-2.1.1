        ...
        <ext:FormPanel 
            ...
            <Items>
                <ext:Panel runat="server">
                    <Items>
                        <ext:TextField runat="server" FieldLabel="First Name" AnchorHorizontal="-5" Name="first" />
                        <ext:TextField runat="server" FieldLabel="Company" AnchorHorizontal="-5" Name="company" />
                    </Items>
                </ext:Panel>

                <ext:Panel runat="server">
                    <Items>
                        <ext:TextField runat="server" FieldLabel="Last Name" AnchorHorizontal="100%" Name="last" />
                        <ext:TextField runat="server" FieldLabel="Email" AnchorHorizontal="100%" Name="email" Vtype="email" />
                    </Items>
                </ext:Panel>
            </Items>
