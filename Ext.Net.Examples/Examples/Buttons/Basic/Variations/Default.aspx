...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!X.IsAjaxRequest)
        {
            ...
            this.RenderButtons("Link Buttons", configs, new Ext.Net.Button.Config { Cls = "floater", Href = "http://www.sencha.com/" });
        }   
    }
