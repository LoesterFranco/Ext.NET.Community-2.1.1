            ...
            <ext:TabPanel runat="server">
                <Items>
                    ...
                    <ext:Panel ID="Tab3" runat="server" Title="Load View Via AutoLoad">
                        <Loader Url="/Dynamic_Partial_Rendering/ASPX_Engine/View1" DisableCaching="true" TriggerEvent="activate" TriggerControl="#{Tab3}" Scripts="true">      
                            <Params>
                                <ext:Parameter Name="containerId" Value="#{Tab3}.body.id" Mode="Raw" />
                            </Params>                      
                        </Loader>
                    </ext:Panel>
